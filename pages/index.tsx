...
import mobileSlider1Img from '../assets/banner.jpg';
import mobileSlider2Img from '../assets/banner2.jpeg';
	...
	return (
		<MainLayout mainMenu={mainMenu} footerMenu={footerMenu} basicSettings={basicSettings}>
			<div className='container-xxl'>
				<MainPageSlider />
				<h1 className='page-heading page-heading_h1  page-heading_m-h1'>Our Products</h1>
				<ProductsList
					products={products}
